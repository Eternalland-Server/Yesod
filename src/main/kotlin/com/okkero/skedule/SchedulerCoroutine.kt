...
fun Plugin.schedule(initialContext: SynchronizationContext = SYNC,
    ...
    return server.scheduler.schedule(initialContext, co)
}
 ...
 */
fun BukkitScheduler.schedule(initialContext: SynchronizationContext = SYNC, co: suspend BukkitSchedulerController.() -> Unit): CoroutineTask {
    val controller = BukkitSchedulerController(Yesod.plugin, this)
